 ...
 * key_prefix (string) - The prefix of the key in redis (defaults to PRERENDER_REDIS)
 */
...
var KEY_PREFIX = process.env.KEY_PREFIX || 'PRERENDER_REDIS';
...
module.exports = {
    requestReceived: function (req, res, next) {
        ...
        client.get(KEY_PREFIX + ':' + req.prerender.url, function (error, result) {
            if (!error && result) {
    ...
    pageLoaded: function (req, res, next) {
        ...
        var key = KEY_PREFIX + ':' + req.prerender.url;
        var response = {
